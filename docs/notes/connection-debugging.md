> **Note:** internal hostnames appear in this debugging transcript. Keep it out of
> public repos, and never paste credentials into notes like this — one did end up in git
> (see README §9). Move secrets to a password manager.
